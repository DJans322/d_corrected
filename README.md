...
```
python train.py --cfg configs/cuhk_sysu_da.yaml > training.log 2>&1

python train.py --cfg configs/cuhk_sysu_da.yaml > "training_$(date +%Y%m%d_%H%M%S).log" 2>&1
nohup ./gpu_monitor.sh & #后台
